...
import frc.team3602.lib.util.COTSFalconSwerveConstants;
import frc.team3602.lib.util.SwerveModuleConstants;
...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double trackWidth = Units.inchesToMeters(18.25); // TODO: This must be tuned
                                                                         // to specific robot
    public static final double wheelBase = Units.inchesToMeters(23.25); // TODO: This must be tuned
                                                                        // to specific robot
     ...
     */
    public static final double openLoopRamp = 0.30;
    public static final double closedLoopRamp = 0.10;
    ...
    /** Radians per Second */
    public static final double maxAngularVelocity = 10.0; // TODO: This must be tuned to specific
                                                          // robot
    ...
    public static final class Mod0 { // TODO: This must be tuned to specific robot
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(330.46);
    ...
    public static final class Mod1 { // TODO: This must be tuned to specific robot
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(43.68);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod2 { // TODO: This must be tuned to specific robot
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(251.19);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod3 { // TODO: This must be tuned to specific robot
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(34.18);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  }
  ...
  public static final class ArmConstants {
    ...
    public static final double armExtendGearRatio = (20.0 / 1.0);
